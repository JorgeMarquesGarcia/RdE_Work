...
const char* ei_classifier_inferencing_categories[] = { "BMU", "BPU", "KPU", "NOISE", "PU" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_9_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_9_axes_size = 6;
...
const ei_impulse_t impulse_640615_0 = {
    ...
    .raw_sample_count = 400,
    .raw_samples_per_frame = 6,
    .dsp_input_frame_size = 400 * 6,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 10,
